      ...
      <Container className={`${classes.e_container} animate`} maxWidth="lg">
        <Grid container spacing={3}>
          <Grid item xs={12} sm={6}>
            ...
            <Moment format="YYYY/MM/DD">{work.fields.date}</Moment>
            <div className={classes.e_tech}>
              ...
              {work.fields.eCommerce ? (
                <p>
                  <IoIosCart /> e-Commerce
                </p>
              ) : null}
              {work.fields.illustrator ? (
                <p>
                  <IoIosBrush /> Illustrator
                </p>
              ) : null}
              {work.fields.photoshop ? (
                <p>
                  <IoIosBrowsers /> Photoshop
                </p>
              ) : null}
              {work.fields.wordpress ? (
                <p>
                  <IoLogoWordpress /> Wordpress
                </p>
              ) : null}
            </div>
            <button
              className={classes.e_btn}
